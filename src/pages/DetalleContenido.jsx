                ...
                <div className="bg-white dark:bg-[#1a1a1a] rounded-xl p-4 shadow-sm">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden bg-gray-200 dark:bg-[#191B1E]">
                                <AvatarRenderer 
                        ...
                        <div className="flex items-center gap-2 md:gap-4">
                            <div className="flex items-center gap-1 px-3 py-1.5 bg-gray-100 dark:bg-[#191B1E] rounded-full text-xs font-medium text-gray-700 dark:text-gray-300">
                                <Download size={14} />
                            ...
                            {item.descargas.map((d, idx) => (
                                <button 
                                    ...
                                    className={clsx(
                                        ...
                                        downloading === d.url 
                                            ? "bg-gray-100 dark:bg-[#191B1E] border-gray-300 dark:border-gray-700 cursor-not-allowed" 
                                            : "bg-gray-50 dark:bg-[#191B1E] border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-[#191B1E] hover:border-primary-300 dark:hover:border-primary-700"
                                    )}
                                >
                                    <div className="flex flex-col">
                    ...
                    <div className="bg-white dark:bg-[#1e1e1e] p-3 md:p-4 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {item.tags?.map((tag, index) => (
                                <div 
                                    key={index} 
                                    className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-gray-50 dark:bg-[#191B1E] border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                                >
