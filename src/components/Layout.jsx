  ...
  return (
    <div className="flex h-screen p-0 md:p-3 gap-3 bg-light-bg dark:bg-dark-bg transition-colors duration-300 overflow-hidden relative">
      ...
      <div className="flex flex-col flex-1 gap-0 md:gap-3 min-w-0 h-full">
        ...
        <main className="flex-1 overflow-auto rounded-none md:rounded-xl bg-light-surface dark:bg-dark-surface shadow-lg p-3 pb-4 md:pb-6 md:p-6 transition-colors duration-300 border-0 md:border border-gray-200 dark:border-gray-800 relative z-0">
          <Outlet />
        </main>
      </div>
    </div>
