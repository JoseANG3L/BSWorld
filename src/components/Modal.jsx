          ...
          <div className={clsx(
            ...
            {showCancel && (
              <button 
                ...
                className={clsx(
                  "py-2.5 px-4 rounded-xl font-bold text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-xs md:text-sm",
                  neutralText ? "w-full sm:flex-1" : "flex-1"
                )}
              >
                {cancelText}
