    ...
    >
      ...
      <div className="px-5 pb-5">
        ...
        <div className="relative -mt-10 mb-3 flex justify-between items-end">
          ...
          {/* Avatar con Renderer */}
          <div className="w-20 h-20 rounded-full border-4 border-white dark:border-[#1e1e1e] shadow-md overflow-hidden bg-gray-200 dark:bg-[#1D1F23]">
             <AvatarRenderer avatar={avatar} name={username} />
          </div>
          
          {/* Icono de flecha */}
          <div className="mb-1 p-2 rounded-full bg-gray-100 dark:bg-[#1D1F23] text-gray-500 dark:text-gray-400 group-hover:bg-primary-600 group-hover:text-white transition-colors">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 mt-2 text-xs text-gray-500 dark:text-gray-400 font-medium">
            <span className="flex items-center gap-1 bg-gray-100 dark:bg-[#1D1F23] px-2 py-1 rounded-md border border-gray-200 dark:border-gray-700">
            ...
            <span className={clsx(
              ...
              role === 'admin' 
                ...
                : "bg-gray-50 text-gray-600 border-gray-200 dark:bg-[#1D1F23] dark:text-gray-300 dark:border-gray-700"
            )}>
